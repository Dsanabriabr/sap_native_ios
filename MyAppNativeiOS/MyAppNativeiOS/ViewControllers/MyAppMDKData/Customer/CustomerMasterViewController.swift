...
class CustomerMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private var entities: [MyAppMDKDataFmwk.Customer] = .init()
    ...
    private func addTableHeaderView() {
        ...
        tableHeader.headlineText = "Customer"
...
//        tableView.estimatedRowHeight = 98
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        return CellCreationHelper.objectCellWithSwiftContent(tableView: tableView, indexPath: indexPath, key: "\(customer.customerID!)", value: "\(customer.firstName!)")
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            detailViewController.navigationItem.title = "\(entities[(tableView.indexPathForSelectedRow?.row)!].customerID != nil ? "\(entities[(tableView.indexPathForSelectedRow?.row)!].customerID!)" : "")"
...
extension CustomerMasterViewController: MyAppMDKDataEntitySetUpdaterDelegate {
