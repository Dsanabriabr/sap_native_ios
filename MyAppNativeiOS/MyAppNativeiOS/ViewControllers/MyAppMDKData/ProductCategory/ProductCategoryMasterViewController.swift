...
class ProductCategoryMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    var loadEntitiesBlock: (() async throws -> [MyAppMDKDataFmwk.ProductCategory])?
    private var entities: [MyAppMDKDataFmwk.ProductCategory] = .init()
    ...
    private func addTableHeaderView() {
        ...
        tableHeader.headlineText = "ProductCategory"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        return CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "Category", value: "\(productCategory.category!)")
    }
    ...
    func requestEntities() async throws {
        entities = try await loadEntitiesBlock!().sorted(by: { ($0.category!) < ($1.category!) })
    }
...
extension ProductCategoryMasterViewController: MyAppMDKDataEntitySetUpdaterDelegate {
