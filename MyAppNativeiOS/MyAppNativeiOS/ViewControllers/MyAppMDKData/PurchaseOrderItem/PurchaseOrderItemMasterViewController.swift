...
class PurchaseOrderItemMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    var loadEntitiesBlock: (() async throws -> [MyAppMDKDataFmwk.PurchaseOrderItem])?
    private var entities: [MyAppMDKDataFmwk.PurchaseOrderItem] = .init()
    ...
    private func addTableHeaderView() {
        ...
        tableHeader.headlineText = "PurchaseOrderItem"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        return CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "ItemNumber, PurchaseOrderID", value: "\(purchaseOrderItem.itemNumber!), \(purchaseOrderItem.purchaseOrderID!)")
    }
    ...
    func requestEntities() async throws {
        entities = try await loadEntitiesBlock!().sorted(by: { ($0.itemNumber!, $0.purchaseOrderID!) < ($1.itemNumber!, $1.purchaseOrderID!) })
    }
...
extension PurchaseOrderItemMasterViewController: MyAppMDKDataEntitySetUpdaterDelegate {
