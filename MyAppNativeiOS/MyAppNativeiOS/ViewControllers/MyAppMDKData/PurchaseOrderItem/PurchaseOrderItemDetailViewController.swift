...
class PurchaseOrderItemDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    var loadEntityBlock: (() async throws -> MyAppMDKDataFmwk.PurchaseOrderItem)?
    private var validity = [String: Bool]()
    var allowsEditableCells = false

    private var _entity: MyAppMDKDataFmwk.PurchaseOrderItem?
    var entity: MyAppMDKDataFmwk.PurchaseOrderItem {
        get {
            if _entity == nil {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            return cellForCurrencyCode(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.PurchaseOrderItem.currencyCode)
        case 1:
            return cellForGrossAmount(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.PurchaseOrderItem.grossAmount)
        case 2:
            return cellForItemNumber(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.PurchaseOrderItem.itemNumber)
        case 3:
            return cellForNetAmount(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.PurchaseOrderItem.netAmount)
        case 4:
            return cellForProductID(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.PurchaseOrderItem.productID)
        case 5:
            return cellForPurchaseOrderID(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.PurchaseOrderItem.purchaseOrderID)
        case 6:
            return cellForQuantity(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.PurchaseOrderItem.quantity)
        case 7:
            return cellForQuantityUnit(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.PurchaseOrderItem.quantityUnit)
        case 8:
            return cellForTaxAmount(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.PurchaseOrderItem.taxAmount)
        case 9:
        ...
        case 9:
            if !entity.isNew {
                ...
                func loadProperty() async throws -> MyAppMDKDataFmwk.Product {
                    try await dataService.loadProperty(MyAppMDKDataFmwk.PurchaseOrderItem.product, into: entity)
        ...
        case 10:
            if !entity.isNew {
                ...
                func loadProperty() async throws -> MyAppMDKDataFmwk.PurchaseOrderHeader {
                    try await dataService.loadProperty(MyAppMDKDataFmwk.PurchaseOrderItem.header, into: entity)
                    hideFioriLoadingIndicator()
    ...
    private func cellForCurrencyCode(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.PurchaseOrderItem, property: Property) -> UITableViewCell {
        var value = ""
        ...
        return CellCreationHelper.cellForProperty(tableView: tableView, indexPath: indexPath, entity: entity, property: property, value: value, editingIsAllowed: allowsEditableCells, changeHandler: { (newValue: String) -> Bool in
            ...
            if newValue.isEmpty {
                ...
                if MyAppMDKDataFmwk.PurchaseOrderItem.currencyCode.isOptional || newValue != "" {
    ...
    private func cellForGrossAmount(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.PurchaseOrderItem, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForItemNumber(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.PurchaseOrderItem, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForNetAmount(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.PurchaseOrderItem, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForProductID(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.PurchaseOrderItem, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForPurchaseOrderID(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.PurchaseOrderItem, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForQuantity(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.PurchaseOrderItem, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForQuantityUnit(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.PurchaseOrderItem, property: Property) -> UITableViewCell {
        var value = ""
        ...
        return CellCreationHelper.cellForProperty(tableView: tableView, indexPath: indexPath, entity: entity, property: property, value: value, editingIsAllowed: allowsEditableCells, changeHandler: { (newValue: String) -> Bool in
            ...
            if newValue.isEmpty {
                ...
                if MyAppMDKDataFmwk.PurchaseOrderItem.quantityUnit.isOptional || newValue != "" {
    ...
    private func cellForTaxAmount(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.PurchaseOrderItem, property: Property) -> UITableViewCell {
        var value = ""
    ...
    func createEntityWithDefaultValues() -> MyAppMDKDataFmwk.PurchaseOrderItem {
        let newEntity = MyAppMDKDataFmwk.PurchaseOrderItem()

        // Key properties without default value should be invalid by default for Create scenario
        if newEntity.itemNumber == nil {
            validity["ItemNumber"] = false
        }
        if newEntity.purchaseOrderID == nil {
...
extension PurchaseOrderItemDetailViewController: MyAppMDKDataEntityUpdaterDelegate {
    func entityHasChanged(_ entityValue: EntityValue?) {
        if let entity = entityValue {
            let currentEntity = entity as! MyAppMDKDataFmwk.PurchaseOrderItem
