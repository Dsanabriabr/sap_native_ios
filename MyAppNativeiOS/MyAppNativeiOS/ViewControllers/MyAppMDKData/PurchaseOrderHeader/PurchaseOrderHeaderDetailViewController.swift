...
class PurchaseOrderHeaderDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    var loadEntityBlock: (() async throws -> MyAppMDKDataFmwk.PurchaseOrderHeader)?
    private var validity = [String: Bool]()
    var allowsEditableCells = false

    private var _entity: MyAppMDKDataFmwk.PurchaseOrderHeader?
    var entity: MyAppMDKDataFmwk.PurchaseOrderHeader {
        get {
            if _entity == nil {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            return cellForCurrencyCode(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.PurchaseOrderHeader.currencyCode)
        case 1:
            return cellForGrossAmount(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.PurchaseOrderHeader.grossAmount)
        case 2:
            return cellForNetAmount(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.PurchaseOrderHeader.netAmount)
        case 3:
            return cellForPurchaseOrderID(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.PurchaseOrderHeader.purchaseOrderID)
        case 4:
            return cellForSupplierID(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.PurchaseOrderHeader.supplierID)
        case 5:
            return cellForTaxAmount(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.PurchaseOrderHeader.taxAmount)
        case 6:
        ...
        case 6:
            if !entity.isNew {
                ...
                func loadProperty() async throws -> MyAppMDKDataFmwk.Supplier {
                    try await dataService.loadProperty(MyAppMDKDataFmwk.PurchaseOrderHeader.supplier, into: entity)
        ...
        case 7:
            if !entity.isNew {
                ...
                func loadProperty() async throws -> [MyAppMDKDataFmwk.PurchaseOrderItem] {
                    try await dataService.loadProperty(MyAppMDKDataFmwk.PurchaseOrderHeader.items, into: entity)
                    hideFioriLoadingIndicator()
                    return entity.items
                }
    ...
    private func cellForCurrencyCode(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.PurchaseOrderHeader, property: Property) -> UITableViewCell {
        var value = ""
        ...
        return CellCreationHelper.cellForProperty(tableView: tableView, indexPath: indexPath, entity: entity, property: property, value: value, editingIsAllowed: allowsEditableCells, changeHandler: { (newValue: String) -> Bool in
            ...
            if newValue.isEmpty {
                ...
                if MyAppMDKDataFmwk.PurchaseOrderHeader.currencyCode.isOptional || newValue != "" {
    ...
    private func cellForGrossAmount(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.PurchaseOrderHeader, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForNetAmount(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.PurchaseOrderHeader, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForPurchaseOrderID(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.PurchaseOrderHeader, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForSupplierID(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.PurchaseOrderHeader, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForTaxAmount(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.PurchaseOrderHeader, property: Property) -> UITableViewCell {
        var value = ""
    ...
    func createEntityWithDefaultValues() -> MyAppMDKDataFmwk.PurchaseOrderHeader {
        let newEntity = MyAppMDKDataFmwk.PurchaseOrderHeader()
...
extension PurchaseOrderHeaderDetailViewController: MyAppMDKDataEntityUpdaterDelegate {
    func entityHasChanged(_ entityValue: EntityValue?) {
        if let entity = entityValue {
            let currentEntity = entity as! MyAppMDKDataFmwk.PurchaseOrderHeader
