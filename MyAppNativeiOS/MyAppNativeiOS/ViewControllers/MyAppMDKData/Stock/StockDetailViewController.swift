...
class StockDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    var loadEntityBlock: (() async throws -> MyAppMDKDataFmwk.Stock)?
    private var validity = [String: Bool]()
    var allowsEditableCells = false

    private var _entity: MyAppMDKDataFmwk.Stock?
    var entity: MyAppMDKDataFmwk.Stock {
        get {
            if _entity == nil {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            return cellForLotSize(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.Stock.lotSize)
        case 1:
            return cellForMinStock(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.Stock.minStock)
        case 2:
            return cellForProductID(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.Stock.productID)
        case 3:
            return cellForQuantity(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.Stock.quantity)
        case 4:
            return cellForQuantityLessMin(tableView: tableView, indexPath: indexPath, currentEntity: entity, property: MyAppMDKDataFmwk.Stock.quantityLessMin)
        case 5:
        ...
        case 5:
            if !entity.isNew {
                ...
                func loadProperty() async throws -> MyAppMDKDataFmwk.Product {
                    try await dataService.loadProperty(MyAppMDKDataFmwk.Stock.product, into: entity)
    ...
    private func cellForLotSize(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.Stock, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForMinStock(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.Stock, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForProductID(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.Stock, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForQuantity(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.Stock, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForQuantityLessMin(tableView: UITableView, indexPath: IndexPath, currentEntity: MyAppMDKDataFmwk.Stock, property: Property) -> UITableViewCell {
        var value = ""
    ...
    func createEntityWithDefaultValues() -> MyAppMDKDataFmwk.Stock {
        let newEntity = MyAppMDKDataFmwk.Stock()
...
extension StockDetailViewController: MyAppMDKDataEntityUpdaterDelegate {
    func entityHasChanged(_ entityValue: EntityValue?) {
        if let entity = entityValue {
            let currentEntity = entity as! MyAppMDKDataFmwk.Stock
