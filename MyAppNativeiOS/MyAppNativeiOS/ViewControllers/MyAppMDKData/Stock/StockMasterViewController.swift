...
class StockMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    var loadEntitiesBlock: (() async throws -> [MyAppMDKDataFmwk.Stock])?
    private var entities: [MyAppMDKDataFmwk.Stock] = .init()
    ...
    private func addTableHeaderView() {
        ...
        tableHeader.headlineText = "Stock"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        return CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "ProductID", value: "\(stock.productID!)")
    }
...
extension StockMasterViewController: MyAppMDKDataEntitySetUpdaterDelegate {
