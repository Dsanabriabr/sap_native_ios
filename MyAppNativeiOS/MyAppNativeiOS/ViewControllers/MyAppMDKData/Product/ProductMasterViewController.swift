...
class ProductMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    var loadEntitiesBlock: (() async throws -> [MyAppMDKDataFmwk.Product])?
    private var entities: [MyAppMDKDataFmwk.Product] = .init()
    ...
    private func addTableHeaderView() {
        ...
        tableHeader.headlineText = "Product"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        return CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "ProductID", value: "\(product.productID!)")
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            detailViewController.navigationItem.title = "\(entities[(tableView.indexPathForSelectedRow?.row)!].productID != nil ? "\(entities[(tableView.indexPathForSelectedRow?.row)!].productID!)" : "")"
...
extension ProductMasterViewController: MyAppMDKDataEntitySetUpdaterDelegate {
